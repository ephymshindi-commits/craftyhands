...
// ── Hardcoded logo — always shows ────────────────────────────
const DEFAULT_LOGO = 'https://res.cloudinary.com/decw2jxsq/image/upload/v1780316264/craftyhands/c9jbwrdjjm78nexp5c4h.jpg';

export default function Footer({ logoImg }) {
  const displayLogo = logoImg || DEFAULT_LOGO;
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.top}>
        <div className={styles.brand}>
          <Link to="/" className={styles.logoWrap}>
            ...
            <span className={styles.logo}>
              ...
              <span>{config.brand.name.split(' ')[1]}</span>
            </span>
          </Link>
          <p>
            Handmade crochet fashion crafted with love in Nairobi, Kenya.
          ...
          <div className={styles.socials}>
            ...
            <a
              href={config.whatsappUrl('Hello Crafty Hands!')}
              target="_blank" rel="noreferrer"
              aria-label="WhatsApp"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
        ...
        <div className={styles.col}>
          ...
          <ul>
            ...
            <li>
              <a href={config.whatsappUrl('Hello!')} target="_blank" rel="noreferrer">
      ...
      <div className={styles.bottom}>
        <p>
          © {new Date().getFullYear()} {config.brand.name} KE.
          Handmade with love by {config.brand.owner}.
        </p>
